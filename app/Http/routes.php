...
Route::group(['middleware' => ['medinfo']], function () {
    ...
    Route::get('admin/units/fetchaggregateunits', 'Admin\MOAdminController@fetchAggregateUnits');
...
/*    Route::get('admin/micontrols/vtk', 'Admin\MedinfoControlsAdminController@index');
    ...
    // экспорт данных из статдокумекнтов
    Route::get('admin/documents/excelexport', 'ImportExport\DocumentExcelExportController@exportDocuments');
    ...
    Route::get('tests/compare_btw_month_forms', 'Tests\ControlFunctionTestController@compare_btw_month_forms');
    Route::get('tests/compare_btw_year2month_forms', 'Tests\ControlFunctionTestController@compare_btw_year2month_forms');
    Route::get('tests/compare_periods', 'Tests\ControlFunctionTestController@compare_periods');
